...
if(patched!=1) throw new Exception("Unexpected patch count");
asm.Write(args[1]);
...
Console.WriteLine("PASS: exactly one apiKey nullability metadata changes; method bodies and authorization unchanged.");
